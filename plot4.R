...
### picture 1
plot(febdataset$datetime, febdataset$Global_active_power, type = "l", ylab = "Global Active Power", xlab = "")
...
### picture 3
with(febdataset, plot(datetime, Voltage, type = "l"))

### picture 4
with(febdataset, plot(datetime, Global_reactive_power, type = "l"))
